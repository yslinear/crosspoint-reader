...
class EpdFontFamily {
 public:
  ...
  // Returns nullptr on a true miss (no replacement-glyph substitution) — see EpdFont::tryGetGlyph.
  const EpdGlyph* tryGetGlyph(uint32_t cp, Style style = REGULAR) const;
